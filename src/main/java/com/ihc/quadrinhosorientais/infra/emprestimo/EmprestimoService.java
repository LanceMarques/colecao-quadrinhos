...
public class EmprestimoService {
  ...
  public Emprestimo criar(final Emprestimo emprestimo) {
    ...
    final List<EmprestimoTemQuadrinho> quadrinhosEmprestados =
        new ArrayList<EmprestimoTemQuadrinho>();

    for (EmprestimoTemQuadrinho quadrinho : quadrinhos) {

      EmprestimoTemQuadrinho quadrinhoEmprestado =
          new EmprestimoTemQuadrinho(emprestimoSalvo, quadrinho.getQuadrinho());
